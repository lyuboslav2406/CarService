        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairComments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RepairComments_RepairComments_ParentId",
                        column: x => x.ParentId,
                        principalTable: "RepairComments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairImage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepairImage_Repairs_RepairId",
                        column: x => x.RepairId,
                        principalTable: "Repairs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Votes_Repairs_RepairId",
                        column: x => x.RepairId,
                        principalTable: "Repairs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairComments_IsDeleted",
                table: "RepairComments",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_RepairComments_ParentId",
                table: "RepairComments",
                column: "ParentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairImage_IsDeleted",
                table: "RepairImage",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_RepairImage_RepairId",
                table: "RepairImage",
                column: "RepairId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairRequests_IsDeleted",
